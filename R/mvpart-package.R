...
#' @name mvpart-package
#' 
#' @description \packageDescription{mvpart}
#' 
## @details Write details here...
#' 
#' The DESCRIPTION file:
#' \packageDESCRIPTION{mvpart}
#' \packageIndices{mvpart}
#' 
#' @author \packageAuthor{mvpart}
#' Maintainer: \packageMaintainer{mvpart}
#' 
## @references
#' 
## @seealso
#' 
## @examples
## ## To view mvpart tutorial
## vignette("mvpart", package="mvpart")
#'
NULL
##
